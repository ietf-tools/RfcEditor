...
def main():
    ...
    parser = XmlRfcParser(leftSource, verbose=log.verbose,
                          quiet=log.quiet, no_network=options.no_network, resolve_entities=not options.noEntity)
    try:
    ...
    parser = XmlRfcParser(rightSource, verbose=log.verbose,
                          quiet=log.quiet, no_network=options.no_network, resolve_entities=not self.noEntity)
    try:
